      ...
      <ul>
        <li><a href="AdminHome.jsp">Home</a></li>
         ...
         <li><a href="ViewFile.jsp">Files</a></li>
          <li><a  class="active" href="Addsyntheticfingerprintimages.jsp">Add Synthetic Fingerprint</a></li>
...
<div class="wrapper col4">
  <div id="container">
    <div id="content">
        ...
        <h3>Add Finger Print Images</h3>
        
        <form action="AddRepository" method="post" enctype="multipart/form-data">
        <table>
            <tr><th>Choose FingerPrint</th><td><input type="file" name="image" required=""></td></tr>
