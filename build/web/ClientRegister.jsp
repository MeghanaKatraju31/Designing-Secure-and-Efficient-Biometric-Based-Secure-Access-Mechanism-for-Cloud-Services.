<%@page import="com.upload.PrivateKey"%>
  ...
  <div id="head">
    ...
    <div id="topnav">
      <ul>
        ...
        <li class="last"><a href="ResourceServer.jsp">Resource Server</a></li>
      </ul>
    </div>
    <div id="search">
  ...
  <div id="gallery">
      ...
      <form action="ClientRegAction" method="post" enctype="multipart/form-data">
          <table>
              ...
              <tr><th>Number</th><td><input type="text" name="mobile" pattern="[0-9]{10}" title="Mobile number must be exactly 10 digits" required></td></tr>
